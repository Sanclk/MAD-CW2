...
public class Activity_RecipeList extends AppCompatActivity implements View.OnClickListener {
    ...
    public void findRecipes(View view) {
        if (query.trim().length() > 0) {
            Intent intent = new Intent(Activity_RecipeList.this, ListActivity.class);
